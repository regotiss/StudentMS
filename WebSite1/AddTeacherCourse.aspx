<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddTeacherCourse.aspx.cs" Inherits="AddTeacherCourse" MasterPageFile="~/MasterPage.master"%>
            ...
            <div class="col-xs-12 col-smx-6 col-sm-offset-3 col-md-6 col-md-offset-3"
               style="background-color:#eee;margin-bottom:70px;margin-top:30px" >
                  <div class="page-header">
                      <h1 class="text-center" style="color:blue"> Teacher Course </h1>
                  </div>
                  <div class="form-group">
                  
                    <asp:TextBox ID="TextBoxTUN" placeholder="Username of Teacher" runat="server" class="form-control input-lg"></asp:TextBox>
                    
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="TextBoxTUN" ErrorMessage="Teacher Username required" ForeColor="#CC0000" style="font-size: large; "></asp:RequiredFieldValidator>
